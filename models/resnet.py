...
__all__ = ['ResNet', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet152', 'resnet1202','wideResnet28_10','mobilenet']
...
if __name__ == "__main__":
    ...
    model = resnet56(100).cuda()
    summary(model, (3,224,224),96,'cuda')
    exit()
